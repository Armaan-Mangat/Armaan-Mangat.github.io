  ...
  return (
    <main className="bg-richblack text-gray-200 min-h-screen">
      <section className="text-center py-20">
        <h1 className="text-5xl font-extrabold text-indianred mb-6">Projects</h1>
        <div className="max-w-3xl mx-auto text-left">
          {/* Project 1: Communakit App */}
          <h2 className="text-2xl font-semibold text-indianred mt-6">Communakit App</h2>
          ...
          <p className="text-gray-300 mt-2">
            <br />
            <a href="https://go.armaanm.ca/project" className="text-indianred hover:underline">Project Link</a> |{' '}
            <a href="https://go.armaanm.ca/prof" className="text-indianred hover:underline">Professor Link</a>
          </p>

          {/* Project 2: Rest API */}
          <h2 className="text-2xl font-semibold text-indianred mt-6">Rest API</h2>
          <p className="text-gray-400">
          ...
          {/* Project 3: HappyHabits */}
          <h2 className="text-2xl font-semibold text-indianred mt-6">HappyHabits</h2>
          <p className="text-gray-400">
          ...
          {/* Project 4: Home Server */}
          <h2 className="text-2xl font-semibold text-indianred mt-6">Home Server</h2>
          <p className="text-gray-400">
